 ...
 *
 * @param textSymbol10
 * @desc ユーザー拡張アクション10の説明
 * @default アクション10
 * @param extendSymbol10
 * @desc ユーザー拡張アクション10です。
 * Input.pressed('ここで設定した文字')で入力を取得できます。
 * @parent textSymbol10
 *
 * @param textSymbol11
 * @desc ユーザー拡張アクション11の説明
 * @default アクション11
 * @param extendSymbol11
 * @desc ユーザー拡張アクション11です。
 * Input.pressed('ここで設定した文字')で入力を取得できます。
 * @parent textSymbol11
 *
 * @param textSymbol12
 * @desc ユーザー拡張アクション12の説明
 * @default アクション12
 * @param extendSymbol12
 * @desc ユーザー拡張アクション12です。
 * Input.pressed('ここで設定した文字')で入力を取得できます。
 * @parent textSymbol12
 *
 * @param textSymbol13
 * @desc ユーザー拡張アクション13の説明
 * @default アクション13
 * @param extendSymbol13
 * @desc ユーザー拡張アクション13です。
 * Input.pressed('ここで設定した文字')で入力を取得できます。
 * @parent textSymbol13
 *
 * @param textSymbol14
 * @desc ユーザー拡張アクション14の説明
 * @default アクション14
 * @param extendSymbol14
 * @desc ユーザー拡張アクション14です。
 * Input.pressed('ここで設定した文字')で入力を取得できます。
 * @parent textSymbol14
 *
 * @param textSymbol15
 * @desc ユーザー拡張アクション15の説明
 * @default アクション15
 * @param extendSymbol15
 * @desc ユーザー拡張アクション15です。
 * Input.pressed('ここで設定した文字')で入力を取得できます。
 * @parent textSymbol15
 *
 * @param textSymbol16
 * @desc ユーザー拡張アクション16の説明
 * @default アクション16
 * @param extendSymbol16
 * @desc ユーザー拡張アクション16です。
 * Input.pressed('ここで設定した文字')で入力を取得できます。
 * @parent textSymbol16
 * 
 * @param symbols
...
const setting = (function(){
    ...
    const helpText ={
        ...
        symbol9 :String(params.textSymbol9),
        symbol10 :String(params.textSymbol10),
        symbol11 :String(params.textSymbol11),
        symbol12 :String(params.textSymbol12),
        symbol13 :String(params.textSymbol13),
        symbol14 :String(params.textSymbol14),
        symbol15 :String(params.textSymbol15),
        symbol16 :String(params.textSymbol16),
...
Window_InputSymbolList.prototype.makeCommandList =function(){
    this._list =[];
    //console.log(setting.symbolList);
    for(var i=0; i <setting.symbolList.length; ++i){
        const actionKey = setting.symbolList[i];
        //console.log(i, symbolToText(actionKey), actionKey);
//        if(9 < i && i < 18){
//            var text = '数値入力' + (i-8);
//        } else {
//            var text = symbolToText(actionKey);
//        }
