...
//★
Window_KeyAction.prototype.numVisibleRows = function() {
    return 8;
};

Window_KeyAction.prototype.maxCols = function() {
    return 2;
};
...
Window_KeyAction.prototype.makeCommandList = function() {
    ...
    //★
    this.addCommand('Input 1', 'ok', true, '1');
    this.addCommand('Input 2', 'ok', true, '2');
    this.addCommand('Input 3', 'ok', true, '3');
    this.addCommand('Input 4', 'ok', true, '4');
    this.addCommand('Input 5', 'ok', true, '5');
    this.addCommand('Input 6', 'ok', true, '6');
    this.addCommand('Input 7', 'ok', true, '7');
    this.addCommand('Input 8', 'ok', true, '8');
    this.addCommand('Input 9', 'ok', true, '9');
    this.addCommand('Input 0', 'ok', true, '0');
...
ConfigManager.keyRemapForCalc = function(){
    ConfigManager.keyMapperBack = JSON.parse(JSON.stringify(ConfigManager.keyMapper));
    //ConfigManager.keyMapperBack = ConfigManager.keyMapper;
    for (var i = 0; i < 10; i++){
        ConfigManager.keyMapper[i+96] = i.toString();
    }
    ConfigManager.keyMapper[8] = 'BS'
    ConfigManager.keyMapper[13] = 'Enter'
    ConfigManager.keyMapper[189] = '-'
    ConfigManager.keyMapper[121] = 'forced'
}

ConfigManager.restoreKeyMapper = function(){
    ConfigManager.keyMapper = ConfigManager.keyMapperBack;
